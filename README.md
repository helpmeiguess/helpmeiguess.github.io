        ...
        <script>
            ...
            async function mainthing() {
                ...
                window.setInterval(async function(){
                    ...
                    tmpbody = body.substring(index+discordid.length+500,index+discordid.length+1500); //i know, i know, dont repeat yourself, but i have no idea how to put this all in a function conveniently.
